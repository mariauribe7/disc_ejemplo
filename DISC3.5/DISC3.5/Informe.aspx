...
<body>
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Gráfico</a>
                                </h4>
                            </div>
                        </div>
                        <div id="collapse3" class="panel-collapse collapse in">
                            <div class="panel-body">
                                <div class="col-lg-12 text-center">
                                    <asp:Label ID="txtD" runat="server" Text="" Visible="false"></asp:Label>
                                    <asp:Label ID="txtI" runat="server" Text="" Visible="false"></asp:Label>
                                    <asp:Label ID="txtS" runat="server" Text="" Visible="false"></asp:Label>
                                    <asp:Label ID="txtC" runat="server" Text="" Visible="false"></asp:Label>
    ...
    <script>
        ...
        var randomScalingFactor1 = function () { return document.getElementById("<%= txtD.ClientID %>").value; };
        var randomScalingFactor2 = function () { return document.getElementById("<%= txtI.ClientID %>").value; };
        var randomScalingFactor3 = function () { return document.getElementById("<%= txtS.ClientID %>").value; };
        var randomScalingFactor4 = function () { return document.getElementById("<%= txtC.ClientID %>").value; };
        var lineChartData = {
            labels: [" ", "D", "I", "S", "C", " "],
            datasets: [
            {
                label: "Resultados DISC",
                ...
                data: [randomScalingFactor(), randomScalingFactor1(), randomScalingFactor1(), randomScalingFactor(), randomScalingFactor(), randomScalingFactor()]
            }
            ]
